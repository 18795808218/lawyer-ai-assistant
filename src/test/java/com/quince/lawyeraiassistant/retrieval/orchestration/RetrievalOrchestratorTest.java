...
class RetrievalOrchestratorTest {
    ...
    void shouldExecuteQueryPipelineBeforeRetrieverPipeline() {
        QueryContext transformedQueryContext =
        ...
        RetrieverContext expectedResult =
    ...
    void shouldCreateInitialQueryContextFromRequest() {
        ArgumentCaptor<QueryContext> queryCaptor =
    ...
    void shouldPassTransformedQueryContextToRetrieverPipeline() {
        ...
        ArgumentCaptor<RetrieverContext>
                retrieverCaptor =
                ArgumentCaptor.forClass(
                        RetrieverContext.class
                );
        ...
        RetrieverContext initialRetrieverContext =
                retrieverCaptor.getValue();
    ...
    void shouldReturnDocumentsProducedByRetrieverPipeline() {
        ...
        RetrieverContext retrievedContext =
                RetrieverContext.builder()
                        .queryContext(
                                transformedQueryContext
                        )
    ...
    void shouldRejectNullConstructorDependencies() {
        NullPointerException queryPipelineException =
                assertThrows(
        ...
        NullPointerException retrieverPipelineException =
                assertThrows(
                        NullPointerException.class,
                        () -> new RetrievalOrchestrator(
                                queryPipeline,
